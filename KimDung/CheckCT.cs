...
namespace KimDung
{
    class CheckCT
    {
        ...
        public string[] amdau = new string[] { "a", "á", "à", "ả", "ạ", "ă", "â", "ẩ", "b", "c", "d", "đ", "e", "é", "ê", "ế", "g", "h", "i",
            "ì", "ỉ", "ĩ", "k", "l", "m", "n", "o", "ó", "ô", "ố", "ồ", "ổ", "ơ", "ớ", "ờ", "ở", "ợ",
            "p", "q", "r", "s", "t", "u", "ú", "ù", "ủ", "ụ", "ư", "ứ", "ừ", "ử", "v", "x", "y", "ý", "ỷ", "ch", "gh",
            "gi", "kh", "ng", "ngh", "nh", "ph", "th", "tr", "ph", "qu" };

        public string[] amdau_dung_mot_minh = new string[] { "a", "á", "à", "ả", "ạ", "e", "ê", "ế", "i",
            "ì", "ỉ", "ĩ", "o", "ó", "ô", "ố", "ồ", "ổ", "ơ", "ớ", "ờ", "ở", "ợ",
        ...
        public string[] amcuoi = new string[] {
            ...
            "inh", "ính", "ình", "ỉnh", "ĩnh", "ịnh", "iết", "iên", "iến", "iền", "iển", "iễn", "iện", "iêm", "iếm", "iềm", "iểm", "iễm", "iệm",
            "oai", "oái", "oài", "oải", "oại",
            ...
            "oang", "oáng", "oàng", "oảng", "oãng", "oạng", "uynh", "uỳnh", "uých", "uỵch",
            "uông","uống","uồng","uổng","uộng", "ương", "ướng", "ường", "ưởng", "ưỡng", "ượng",
            //bo sung am cuoi
            "ữu", "iều", "ắng", "ưu", "uân", "iễu", "ươi", "oá", "ớt", "ộc", "iêu", "ằng","ưỡi","ây","âng","ập","uay","ặp","áng","ướt",
            "ăng", "ưới", "iếc", "ười", "iểu", "ước", "iếu", "ấy", "uổi", "uýt", "oát", "iu","ại","iệu","ấp","ẳng","ệt","uất","oả","uộm",
            "ết", "ịu", "ầy", "oắng", "oạt", "ậy", "yêu", "ược", "iệp","ướm","ánh","uội","iếp","ượt","uật","uốt","uyết","ặng","iệc","yếm",
            "uối","iệt","uở","oà","yên","ùy","íu","oẻn","oè","uấn","ởi","ắp","ợt","yết","ẩy","uyệt","oác","ầng","uộc","oặc","yếu","uột",
            "oé","uôi","uận","ửu","ĩu","oạ","yến","ượm","ứu","ướp","ừu","ẵng","oành","ìu","oắt","oảnh","uya","uốc","ươm","ưỡn","yền",
            "ẩng","oạc","ườm","ỉu","oét","ễm","uần","yện","ẵn","ẫy","ễnh","ểnh","uẩn","ựu","yển","oạch","oanh","oèo","uỗi","ềnh",
            "ấng","oắc","ụy","ệt","uỵt","ũy","ựt","oẹt","òe","uâng","ượi","ẻng","ượu","uỷu","yểu","ưởi","ệu","eng","uẩy","uồm","oẻo",
            "iễng","oẻ","uồi","ướu","oã","uếch","iểng","uẫn","oạm","ươu","ừm","uỵu","uênh","uốm","oặt"
        };
        ...
        public string[] amcuoi_dung_mot_minh = new string[] {
            ...
            "oang", "uynh", "uỳnh","uỵch",
            "uông", "uống", "uổng", "ương",
            //bo sung am cuoi dung mot minh
            "ưu","ớt", "ước","ấy","oát","ủy","ướm","yêu","ánh","áng","ấp","ẳng","yếm","oà","yên","ắp","yết","oác","yếu","yến","ướt",
            "ướp","ỉu","ưỡn","ễnh","uẩn","oanh","yểu","ở","ưa","ập", "ĩ","e","o","ừm","ót","yểm",
            //cac tu dac biet
            "quỳnh","quyệt","giềng","giếng","quýnh","quỵt","giun","quì","quỳ","giữ","dáo","dác","giữa"
        ...
        public string[] cac_cap_am_khong_duoc_dung_cung_nhau = new string[] {
            ...
            "ẩý","ẩỳ","ẩỷ","ẩỹ","ẩỵ","bũ","by","bý","bỳ","bỷ","bỹ","bỵ","ce","cé","cè","cẻ","cẽ","cẹ",
            "cê","cế","cề","cể","cễ","cệ","ci","cí","cì","cỉ","cĩ","cị","cy","cý","cỳ","cỷ","cỹ","cỵ","de","dẽ",
            "dỉ","dỏ","dổ","dớ","dủ","dy","dý","dỳ","dỷ","dỹ","dỵ","đở","đử","đữ","đy","đý",
            ...
            "ếợ","ếu","ếú","ếù","ếủ","ếũ","ếụ","ếư","ếứ","ếừ","ếử","ếữ","ếự","ếy","ếý","ếỳ","ếỷ","ếỹ","ếỵ","ge","gé","gè","gẻ","gẽ",
            "gẹ","gê","gế","gề","gể","gễ","gệ","gí","gĩ","gy","gý","gỳ",
            "gỷ","gỹ","gỵ","hý","hỳ","hỹ","hỵ","iạ","ié","iè","iẽ","iẹ","iê","iữ",
            "iề","iể","iễ","iệ","ii","ií","iì","iỉ","iĩ","iị","io","iồ","iổ","iỗ","iộ",
            "iợ","iu","iủ","iũ","iứ","iừ","iử","iy","iý","iỳ","iỷ","iỹ","iỵ","ìa","ìá","ìà","ìả",
            ...
            "ỉủ","ỉũ","ỉụ","ỉư","ỉứ","ỉừ","ỉử","ỉữ","ỉự","ỉy","ỉý","ỉỳ","ỉỷ","ỉỹ","ỉỵ","ká","kà","kả","kã","kạ","kễ","ko","kó","kò",
            "kỏ","kõ","kọ","kô","kố","kồ","kổ","kỗ","kộ","kơ","kớ","kờ","kở","kỡ","kợ","ku","kú","kù","kủ","kũ","kụ","kư","kứ","kừ","kử",
            "kữ","kự","lỳ","lỷ","lỹ","lỵ","mể","mễ","mữ","my","mý",
            "mỷ","mỵ","nẽ","nẹ","nễ","nĩ","nờ","ny","ný","nỳ","nỷ","nỹ","nỵ","oá","oả","oã","oạ","oe","oé","oè","oẻ",
            ...
            "qỡ","qợ","qu","qú","qù","qủ","qũ","qụ","qư","qứ","qừ","qử","qữ","qự","qy","qý","qỳ","qỷ","qỹ","qỵ",
            "ry","rý","rỳ","rỷ","rỹ","rỵ","sè","sề","sể","sễ","sõ","sy","sý","sỳ","sỷ",
            "sỵ","tỗ","tỡ","tữ","tỹ","uẽ",
            "uề","uể","uễ","uì","uĩ","uị","uo","uó","uò","uỏ","uõ","uọ","uô","uồ","uổ","uỗ","uộ","uớ",
            "uỡ","uợ","uu","uú","uù","uủ","uũ","uụ","uư","uứ","uừ","uử","uữ","uự","úa","úá","úà","úả",
            ...
            "ửỵ","vễ","vổ","vủ","vử","vý","vỳ","vỷ","vỵ","xẽ","xề","xể","xễ","xĩ","xọ","xỗ","xờ","xỡ",
        ...
        {
            "bĩ","dả","dé","dẹ","dể","dó","dợ","dú","dứ","dử","đạ","đẹ","đí","đì","đỉ","đị","đõ","đớ","đũ","ia","gó","uý",
            "đụ","đư","đứ","đừ","đự","gi","gớ","gư","hã","hẻ","hế","hĩ","hị","hó","hỏ","hõ","hỡ","hợ","hụ","hứ",
            "hữ","ka","lé","lỉ","lĩ","lỏ","lồ","lổ","mế","mố","mừ","nà","nả","ne","nế","nệ","ní","nì","nị","nò","nõ","nồ","lậ",
            "nớ","nu","nú","nủ","nũ","nư","nừ","nử","nự","rê","rệ","rí","rị","ró","rỏ","rố","rơ","rớ","rù",
            "rụ","rư","rứ","rừ","rử","rữ","sạ","sé","sẹ","sế","sị","só","sũ","sữ","te","tẹ","tĩ","gá","nứ","ua",
            "tó","tõ","tọ","tở","vẹ","vể","vọ","vư","vứ","vừ","vữ","vự","xú","xư","ià","hẽ","vộ","cã","đợ","xâ","câ","dâ","gợ",
            "gặ","đậ","bư","tấ","bâ","iờ","tậ","gữ","gự","gử","rở","hẳ","uá","ió","rặ","iá","đâ","mư","iọ","hể","nặ","uở",
            "gơ","gộ","tặ","bừ","iố","lặ","đặ","uạ","dố","vâ","mú","gố","uả","cở","uê","rẩ","hẩ","iớ","hắ","vầ","mệ","hấ","cậ",
            "iú","hậ","iả","iư","ue","bẩ","uỵ","iụ","mự","bứ","uỉ","cở","iở","uí","iơ","iế","iỏ","lứ","iã","cõ","uố","uã",
            "gủ","bữ","cợ","xẹ","iỡ","gẩ","ie","bử","gũ","dõ","rề","gỏ","lủ","sẵ","rự","bẫ","mứ","uơ","nố","dờ","uờ","sừ",
            "sỏ","xõ","đé","nấ","tợ","uẻ","đấ","iự","uà","xò","mử","uẹ","tễ","ué","uè","iõ","xộ","iò","iô",
            "đễ","uỹ","gứ","uệ","rẹ","iù","iẻ","dô","sí","tũ","sã","nù","lế","lắ","bắ","đắ","dá"
        };

        public string[] cac_am_cuoi_duoc_di_kem_voi_gh_va_ngh = new string[]
        {
            "i","í","ì","ỉ","ĩ","ị","e","é","è","ẻ","ẽ","ẹ","ê","ế","ề","ễ","ệ","im","ím","ìm","ỉm","ĩm","ịm","in","ín","ìn",
            "ỉn","ĩn","ịn","êu","ếu","ều","ệu","ên","ến","ền","ển","ễn","ện","inh","ính","ình","ỉnh","ĩnh","ịnh","iên",
            "iến","iền","iện","ênh","ếnh","ềnh","iêng","en","én","èn","ẻn","ẽn","ẹn","ếch","ệch","em","ém","èm","èo","ẻo","ẽo","ẹo",
            "iếp","iệp","iết","iệt","iêm","iềm","iễm","iệm","ia","ía","ĩa","ích","ịch","ét","ít","ịt","iếc","ẹt"
        };


        public string[] cac_tu_lay_duoc;
        public bool[] check_cac_tu_lay_duoc;
        ...
        public bool checkct(string word)
        {
            ...
            //neu cum tu lay duoc bao gom toan so thi chac chan khong sai chinh ta
            Regex kiemtratoanso = new Regex(@"(\d+)");
            if (kiemtratoanso.IsMatch(tmpword))
            {
                checkdau = true;
                checkcuoi = true;
            }
            ...
            //MessageBox.Show(checkdau.ToString() + checkcuoi.ToString() + checkgiua + " " + tmpword + " " + amdautmp2 + " " + amcuoitmp);
            if (checkdau == false)
            {
                checkdau = true;
                while (checktmp1)
            ...
            //MessageBox.Show(checkdau.ToString() + checkcuoi.ToString() + checkgiua.ToString() + amdautmp2+" "+amcuoitmp);
            ...
            {
                if ((amdautmp2 == "gh") || (amdautmp2 == "ngh"))
                {
                    foreach(string ac in cac_am_cuoi_duoc_di_kem_voi_gh_va_ngh)
                    {
                        if(amcuoitmp == ac)
                        {
                            checkgiua = true;
        ...
        public void kiem_tra_chinh_ta()
        {
            for(int i=0; i<cac_tu_lay_duoc.Length;i++)
            {
                check_cac_tu_lay_duoc[i] = checkword(cac_tu_lay_duoc[i]);
            }
        }
    }
}
